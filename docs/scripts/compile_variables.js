...
const COMMAND_XBOT_SDK_VERSION =
  'python -c "from xbot import __version__ as xbot_version; print(xbot_version)"';
...
const getRasaSdkVersion = () => execSync(COMMAND_XBOT_SDK_VERSION).toString().trim();
