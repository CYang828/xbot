...
from xbot.nlu.slot.nlu import NLU
...
from data.crosswoz.data_process.nlu_preprocess import  preprocess
...
class BERTNLU(NLU):
    ...
    def predict(self, utterance, context=list()):
        ...
        slot_logits, intent_logits = self.model(word_seq_tensor, word_mask_tensor,
