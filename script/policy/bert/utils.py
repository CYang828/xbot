...
try:
    ...
    def get_act_ontology(raw_data_path: str, output_path: str) -> None:
        ...
        act_ontology = set()
        for dial_id, dial in tqdm(raw_data.items(), desc='Generate action ontology ...'):
...
def preprocess(raw_data_path: str, output_path: str, data_type: str) -> List[Dict[str, list]]:
...
def cache_data(data_type: str, examples: List[Dict[str, list]], output_path: str) -> None:
    """Save processed data."""
